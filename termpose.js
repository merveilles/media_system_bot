(function (console, $hx_exports) {
    ...
    StringIterator.prototype = {
        ...
        peek: function () {
            if (this.i < this.s.length)
                return HxOverrides.cca(this.s, this.i);
            else
                return null;
        },
    ...
    Term.prototype = $extend(Stringificable.prototype, {
        ...
        buildPrettyPrint: function (sb, numberOfSpacesElseTab, windowsLineEndings, maxLineWidth) {
            var indent;
            if (numberOfSpacesElseTab != null)
                indent = Parser.repeatString(" ", numberOfSpacesElseTab);
            else
                indent = "\t";
            var lineEndings;
    ...
    Parser.prefixes = function (shorter, longer) {
        if (shorter.length > longer.length)
            ...
            while (_g1 < _g) {
                var i = _g1++;
                if (HxOverrides.cca(shorter, i) != HxOverrides.cca(longer, i))
                    return false;
            }
            return true;
        }
    ...
    Parser.escapeIsNeeded = function (sy) {
        ...
        while (_g1 < _g) {
            ...
            if (c == 32 || c == 40 || c == 58 || c == 9 || c == 10 || c == 13 || c == 41)
                return true;
        }
        return sy.length == 0;
    };
    ...
    Parser.prototype = {
        ...
        finishTakingIndentationAndAdjustLineAttachment: function () {
            ...
            if (this.hasFoundLine) {
                if (this.salientIndentation.length > this.previousIndentation.length) {
                    if (!Parser.prefixes(this.previousIndentation, this.salientIndentation))
                        this.breakAt(this.line - this.salientIndentation.length, this.column, "inconsistent indentation at");
                    if (this.parenTermStack.length > 1 || this.containsImmediateNext != null)
                    ...
                    this.containsImmediateNext = null;
                    if (this.salientIndentation.length < this.previousIndentation.length) {
                        if (!Parser.prefixes(this.salientIndentation, this.previousIndentation))
                            this.breakAt(this.line, this.column, "inconsistent indentation");
                        while (this.indentStack[this.indentStack.length - 1].depth > this.salientIndentation.length) {
                            if (this.indentStack[this.indentStack.length - 1].depth < this.salientIndentation.length)
                                this.breakAt(this.line, this.column, "inconsistent indentation, sibling elements have different indentation");
            ...
            if (fileEnd) {
                ...
                switch (c) {
                    ...
                    case 92:
                        ...
                        break;
                    case 10:
                        if (this.stringBuffer.b.length == 0)
                            this.transition($bind(this, this.multiLineFirstLine));
                        else {
                            this.finishTakingSymbolAndAttach();
                            this.transition($bind(this, this.eatingIndentation));
                        }
        ...
        takingEscape: function (fileEnd, c) {
            if (fileEnd)
                this.giveUp("invalid escape sequence, no one can escape the end of the file");
            else {
                var g = c;
                switch (c) {
                    case 104:
                    ...
                    default:
                        ...
                        if (this.multilineStringsIndent.length > this.salientIndentation.length) {
                            if (Parser.prefixes(this.salientIndentation, this.multilineStringsIndent)) {
                                ...
                                this.giveUp("inconsistent indentation");
                        }
                        else {
                            this.finishTakingSymbolAndAttach();
                            this.stringBuffer = new StringBuf();
    ...
    WoodslistParser.escapeIsNeeded = function (sy) {
        ...
        while (_g1 < _g) {
            var i = _g1++;
            var c = HxOverrides.cca(sy, i);
            if (c == 32 || c == 40 || c == 9 || c == 10 || c == 13 || c == 41)
                return true;
        }
        return false;
    };
    ...
    WoodslistParser.prototype = {
        ...
        beginQuoted: function () {
            ...
            if (nc == 10 || nc == 13)
                this.moveCharPtrAndUpdateLineCol();
        ...
        eatingQuotedString: function (co) {
            ...
            if (co == null)
                this.giveUp("unmatched quote, by the end of data");
            else
                switch (co) {
                    case 92:
